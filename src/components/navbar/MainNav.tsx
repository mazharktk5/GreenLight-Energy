                ...
                <ul className="hidden md:flex items-center gap-8">
                    {navLinks.map((link) => (
                        <li key={link.label}>
                            <Link
                                href={link.href}
                                className="text-dark/65 hover:text-primary text-sm font-medium flex items-center gap-1 transition-colors duration-200"
                            >
                                {link.label}
                    ...
                    <ul className="flex flex-col gap-5">
                        {navLinks.map((link) => (
                            <li key={link.label}>
                                <Link
                                    href={link.href}
                                    className="text-dark/70 hover:text-primary text-sm font-medium block transition-colors"
